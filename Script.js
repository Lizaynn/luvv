...
if (url.searchParams.get('sayangkuu') != null) {
  sender = url.searchParams.get('sayangkuu');
} else {
  sender = "Lzzzz";
}
    ...
    Swal.fire("Jawab jujur yaa sayangg").then(function () {
      Swal.fire("Awasss yaaa kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          title: 'Isii nama kamuu yaaa aswil:v',
          input: 'text',
          inputLabel: '',
          ...
          const pertanyaan = Swal.fire({
            title: `${aswil} kamuu sayang ga sama ${Lz}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${lzzz} juga sayang banget sama ${aswill:v}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya yang udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhuhuhuhu iya ${lz} juga kangen bangett samaaa ${aswill} , makasihhh yaa :)`).then(function () {
              ...
              Swal.fire(`Yakin kamu ga sayang sama ${Lzz}?`, '', 'error').then(function () {
                Swal.fire('Ok deh :((')
              })
            }
          })
